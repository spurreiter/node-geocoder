...
const HttpAdapter  = require("../lib/httpadapter/httpadapter.js"), HttpsAdapter = require("../lib/httpadapter/httpsadapter.js");
...
describe("GeocoderFactory", () => {
    ...
    describe("getGeocoder" , () => {
        ...
        test(
            ...
            () => {
                const geocoder = GeocoderFactory.getGeocoder("google", "https", {clientId: "CLIENT_ID", apiKey: "API_KEY"});
        ...
        test(
            ...
            () => {
                const geocoder = GeocoderFactory.getGeocoder({provider: "google", clientId: "CLIENT_ID", apiKey: "API_KEY"});
        ...
        test(
            ...
            () => {
                const geocoder = GeocoderFactory.getGeocoder("google", "https", {clientId: "CLIENT_ID", apiKey: "API_KEY", excludePartialMatches: true});
        ...
        test(
            ...
            () => {
                const geocoder = GeocoderFactory.getGeocoder("google", "http", {language: "fr",region:"de"});
        ...
        test(
            ...
            () => {
                const geocoder = GeocoderFactory.getGeocoder("google", "http", { formatter : "gpx"});

                const geocoderAdapter = geocoder._geocoder;
                let formatter = geocoder._formatter;
        ...
        test(
            ...
            () => {
                const geocoder = GeocoderFactory.getGeocoder("google", "http", { formatter : "string", formatterPattern: "PATTERN"});
        ...
        test(
            ...
            () => {
                const geocoder = GeocoderFactory.getGeocoder({provider: "here", httpAdapter: "http", appId: "APP_ID", appCode: "APP_CODE"});
        ...
        test(
            ...
            () => {
                const geocoder = GeocoderFactory.getGeocoder("here", "https", {appId: "APP_ID", appCode: "APP_CODE"});
        ...
        test(
            ...
            () => {
                const geocoder = GeocoderFactory.getGeocoder("here", "http", {appId: "APP_ID", appCode: "APP_CODE", language:"en"});
        ...
        test(
            ...
            () => {
                const geocoder = GeocoderFactory.getGeocoder("here", "http", {appId: "APP_ID", appCode: "APP_CODE", politicalView:"GRE"});
        ...
        test(
            ...
            () => {
                const geocoder = GeocoderFactory.getGeocoder("here", "http", {appId: "APP_ID", appCode: "APP_CODE", country:"FR"});
        ...
        test(
            ...
            () => {
                const geocoder = GeocoderFactory.getGeocoder("here", "http", {appId: "APP_ID", appCode: "APP_CODE", state:"Île-de-France"});
        ...
        test(
            ...
            () => {
                const geocoder = GeocoderFactory.getGeocoder("here", "http", {appId: "APP_ID", appCode: "APP_CODE", formatter : "gpx"});
        ...
        test(
            ...
            () => {
                const geocoder = GeocoderFactory.getGeocoder("here", "http", {appId: "APP_ID", appCode: "APP_CODE", formatter : "string", formatterPattern: "PATTERN"});
        ...
        test(
            ...
            () => {
                const geocoder = GeocoderFactory.getGeocoder("datasciencetoolkit", "http");
        ...
        test(
            ...
            () => {
                const geocoder = GeocoderFactory.getGeocoder("datasciencetoolkit", "http", {"host" : "raoul.io"});
        ...
        test(
            ...
            () => {
                const geocoder = GeocoderFactory.getGeocoder("locationiq", "http", {apiKey: "API_KEY"});
        ...
        test(
            ...
            () => {
                ...
                const geocoder = GeocoderFactory.getGeocoder("google", "https", {clientId: "CLIENT_ID", apiKey: "API_KEY", timeout: timeout});
        ...
        test(
            ...
            () => {
                const geocoder = GeocoderFactory.getGeocoder("pickpoint", "https", {apiKey: "API_KEY"});
