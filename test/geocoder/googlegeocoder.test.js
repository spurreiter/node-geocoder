...
describe("GoogleGeocoder", () => {
  describe("#constructor" , () => {
    ...
    test(
      ...
      () => {
        const googleAdapter = new GoogleGeocoder(mockedHttpAdapter, {clientId: "CLIENT_ID", apiKey: "API_KEY"});
  ...
  describe("#geocode" , () => {
    ...
    test("Should accept `language` and `region` as options", () => {
      ...
      const googleAdapter = new GoogleGeocoder(mockedHttpAdapter, { language: "fr", region: ".ru" });
    ...
    test(
      ...
      () => {
        ...
        const googleAdapter = new GoogleGeocoder(mockedHttpAdapter, { language: "fr" });
    ...
    test(
      ...
      () => {
        ...
        const googleAdapter = new GoogleGeocoder(mockedHttpAdapter, { region: "fr" });
    ...
    test("Should call httpAdapter get method with key if specified", () => {
      ...
      const googleAdapter = new GoogleGeocoder(mockedHttpAdapter, { apiKey: "hey-you-guys" });
    ...
    test(
      "Should exclude partial match geocoded address if excludePartialMatches option is set to true",
        ...
        const googleAdapter = new GoogleGeocoder(mockedHttpAdapter, { clientId: "clientId", apiKey: "apiKey", excludePartialMatches: true});
    ...
    test(
      "Should include partial match geocoded address if excludePartialMatches option is set to false",
        ...
        const googleAdapter = new GoogleGeocoder(mockedHttpAdapter, { excludePartialMatches: false});
  ...
  describe("#reverse" , () => {
    ...
    test(
      ...
      () => {
        ...
        const googleAdapter = new GoogleGeocoder(mockedHttpAdapter, {clientId: "raoul", apiKey: "foo"});
    ...
    test(
      ...
      () => {
        const googleAdapter = new GoogleGeocoder(mockedHttpAdapter, {clientId: "james", apiKey: "foo"});
        const params = {
          sensor: false,
          client: "james",
          address:  "qqslfzxytfr"
