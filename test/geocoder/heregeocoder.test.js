    ...
    describe("HereGeocoder", () => {
        ...
        describe("#constructor" , () => {
            ...
            test(
                ...
                () => {
                    const hereAdapter = new HereGeocoder(mockedHttpAdapter, {appId: "APP_ID", appCode: "APP_CODE"});
            ...
            test("Should use production endpoint, if production is provided", () => {
                const hereAdapter = new HereGeocoder(mockedHttpAdapter, {appId: "APP_ID", appCode: "APP_CODE", production: true});
        ...
        describe("#geocode" , () => {
            ...
            test(
                ...
                () => {
                    ...
                    const hereAdapter = new HereGeocoder(mockedHttpAdapter, {appId: "APP_ID", appCode: "APP_CODE", language: "en"});
            ...
            test(
                ...
                () => {
                    ...
                    const hereAdapter = new HereGeocoder(mockedHttpAdapter, {appId: "APP_ID", appCode: "APP_CODE", politicalView: "GRE"});
            ...
            test(
                ...
                () => {
                    ...
                    const hereAdapter = new HereGeocoder(mockedHttpAdapter, {appId: "APP_ID", appCode: "APP_CODE", country: "FR"});
            ...
            test("Should call httpAdapter get method with state if specified", () => {
                ...
                const hereAdapter = new HereGeocoder(mockedHttpAdapter, {appId: "APP_ID", appCode: "APP_CODE", state: "Île-de-France"});
            ...
            test(
                ...
                () => {
                    ...
                    const hereAdapter = new HereGeocoder(mockedHttpAdapter, {appId: "APP_ID", appCode: "APP_CODE", country: "FR", state: "Île-de-France" });
