const util             = require("util"), AbstractGeocoder = require("./abstractgeocoder");

/**
 * Constructor
 */
const OpenStreetMapGeocoder = function OpenStreetMapGeocoder(httpAdapter, options) {
    this.options = ["language","email","apiKey", "osmServer"];

    OpenStreetMapGeocoder.super_.call(this, httpAdapter, options);
    const osmServer = (options && options.osmServer) || "http://nominatim.openstreetmap.org";
