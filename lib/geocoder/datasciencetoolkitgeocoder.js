const util             = require('util'), net              = require('net'), AbstractGeocoder = require('./abstractgeocoder');

/**
 * Constructor
 */
const DataScienceToolkitGeocoder = function DataScienceToolkitGeocoder(httpAdapter,options) {
    this.options     = ['host'];
