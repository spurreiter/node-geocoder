 ...
 */
const AGOLGeocoder = function AGOLGeocoder(httpAdapter, options) {
...
AGOLGeocoder.prototype.geocode = function(value, callback) {
  ...
  const execute = function (value,token,callback) {
    const params = {
      'token':token,
      'f':'json',
      'text':value,
...
AGOLGeocoder.prototype.reverse = function(query, callback) {
  ...
  const execute = function (lat,long,token,callback) {
    const params = {
      'token':token,
      'f':'json',
      'location' : long + ',' + lat,
